...
class Cities extends Component {
  ...
  componentDidMount() {
    ...
    */
    ...
    /*
      Neste setState, nós possuímos uma função sendo passada como segundo parâmetro (uma callback).
      A ideia é garantir que a função loadCities seja executada apenas após a conclusão do setState.
    */
    this.setState({
      uf,
    }, this.loadCities);
